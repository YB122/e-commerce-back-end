...
### 9. Coupon APIs (`coupon-apis.md`)

- POST `/api/v1/coupons/admin` - Add coupon (admin only)
- GET `/api/v1/coupons/admin` - Get all coupons (admin only)
- GET `/api/v1/coupons/admin/:id` - Get one coupon (admin only)
- PUT `/api/v1/coupons/admin` - Update coupon (admin only)
- DELETE `/api/v1/coupons/admin` - Delete/deactivate coupon (admin only)
- GET `/api/v1/coupons` - Get all coupons (user)
- GET `/api/v1/coupons/:id` - Get one coupon (user)
